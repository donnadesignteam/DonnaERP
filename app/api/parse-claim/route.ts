...
schema ของแต่ละ item ใน items:
{
  ...
  "rail_head": "หัวราง เช่น กระดุม วงแหวน · ผ้าม่านจีบใส่จำนวนจีบ เช่น '3จีบ' ถ้าไม่มีใส่ว่าง",
  "hook_type": "ชนิดตะขอ: ตะขอสั้น/ตะขอยาว/ตะขอเพดาน — แยกช่องจากจำนวนจีบ ถ้าไม่มีใส่ว่าง",
