...
8.4 "(ไม่โซ่)" / "(ถ่วงโซ่)" / "ไม่ถ่วงโซ่" ที่ต่อท้ายบรรทัดขนาดหรือชื่อชนิด → เก็บใน note ของ item นั้น ห้ามตัดทิ้ง
...
10. note ใส่ได้เฉพาะ: ตำแหน่ง (ซ้าย, ขวา, แยกกลาง, บน, ล่าง, ดึงซ้าย, ดึงขวา) หรือเงื่อนไขสั้นๆ (ไม่โซ่, ถ่วงโซ่, ไม่ถ่วงโซ่, พร้อมส่ง, มีตำหนิ, ตัดครึ่งพร้อมตัวต่อ) เท่านั้น ห้ามใส่ข้อมูลสี/ขนาด/แบรนด์
