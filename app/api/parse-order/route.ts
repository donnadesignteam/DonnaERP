...
schema:
{
  ...
  "address": "ที่อยู่จัดส่งเต็มๆ บรรทัดเดียว (มักอยู่ท้ายข้อความหลังคำว่า 'ส่ง'/'ที่อยู่' ต่อจากชื่อผู้รับ) — รวมบ้านเลขที่ หมู่ ซอย หมู่บ้าน ตำบล อำเภอ จังหวัด รหัสไปรษณีย์ ให้ครบตามต้นฉบับ ห้ามตัดทิ้ง ห้ามใส่ชื่อผู้รับหรือเบอร์โทรปนมา ถ้าไม่มีใส่ null",
