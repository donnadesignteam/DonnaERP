...
const WORKFLOW: { key: string; color: string }[] = [
  ...
  { key: 'กำลังตัด', color: '#30d158' },     // สายผลิต — DonnaBot อัปเดตอัตโนมัติจากรูปกลุ่มช่าง
  { key: 'กำลังเย็บ', color: '#5e9eff' },
  { key: 'กำลังรีด', color: '#bf5af2' },
  { key: 'กำลังแพ็ค', color: '#f43f5e' },
