...
// ‼️ งานติดตั้งลงได้ที่หน้าปฏิทินอย่างเดียว (กล่องเพิ่มรายการในหมวดออเดอร์ไม่มีปุ่มงานติดตั้งแล้ว)
//    พอคอลัมน์ "งาน" เป็น "งานติดตั้ง" ระบบจะสร้างใบออเดอร์ให้ ฝ่ายผลิตถึงจะเห็นงานในหมวดออเดอร์
