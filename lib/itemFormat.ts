...
const FIXED_TYPES: [RegExp, string][] = [
  ...
  // สินค้าตกแต่ง (Shopee) — ชื่อหน้าสินค้ายาว/ติดสีมาด้วย เช่น "เบาะนั่งมินิมอล  สีขาวครีม หมอนปุยเมฆ" → "เบาะนั่งมินิมอล"
  // (สีไปช่องสี · ได้หมอนแถมมาด้วยลง note "หมอนปุยเมฆ")
  [/^เบาะ/, 'เบาะนั่งมินิมอล'],
  [/^หมอน/, 'หมอนปุยเมฆ'],
...
export const FIELD_CHOICES: Record<string, string[]> = {
  type: [
    ...
    'กล่องบังราง',
    'เบาะนั่งมินิมอล', 'หมอนปุยเมฆ', 'วอลเปเปอร์',
