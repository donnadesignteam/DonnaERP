...
--   งานเสร็จ TRUE -> สถานะ 'ส่งแล้ว' + ปิดงาน (ผู้ปิด = ผู้ลงข้อมูล, เวลาปิด = วันที่แจ้งเคลม 17:00 น. เพราะชีทไม่มีวันปิดงาน)
...
รอที่อยู่', 'หนูนา', 'หนูนา', '2026-05-02T17:00:00+07:00',
...
รางม่านตาไก่ 1 ชั้น
หัวกระดูม สีขาว ขนาด 1.50 = 3 ชุด', 'กาย', 'กาย', '2026-05-02T17:00:00+07:00',
       NULL, 25, 6, now(), now()
...
select '2026-05-03', 'Shopee', 'noodee99', NULL, NULL, 'ร้าน', 'กค้าสั่งม่านขนาด 4.00 ม. ค่ะ แต่มีการโอนเพิ่มเป็นขนาด 4.80 
 ...
 ยังไม่ได้ลงออเดอร์เพิ่ม รบกวนโอนเงินส่วนต่างคืนลูกค้าตามเลขบัญชีนี้ค่ะ',
       ...
       'โอนแล้ว', 'ส่งแล้ว', 'ชีทเคลม #0003 · สถานะในชีท: งานเสร็จแล้ว · ผิดโดย: กาย · สถานะการชำระในชีท: ชำระสำเร็จ · วิธีแก้: โอนเงินคืนลูกค้า 524', NULL, 'แพท', 'แพท', '2026-05-03T17:00:00+07:00',
...
KB-1 Mocha gray 
ก2.50*ส2.10 = 2 ผืน 2,544 บาท', 'กาย', 'กาย', '2026-06-01T17:00:00+07:00',
       77, 18, 2544, now(), now()
...
*แก้ค่ะ*  @All', 'กาย', 'กาย', '2026-05-04T17:00:00+07:00',
...
ผ้าม่านตาไก่  ตาไก่สุ่มสีขาว
โปร่ง Mid Modern 
ก2.00*ส2.00 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-04T17:00:00+07:00',
       NULL, 25, 678, now(), now()
...
ราง1ชั้น, 2.80 = 2 ชุด', 'หนูนา', 'หนูนา', '2026-05-04T17:00:00+07:00',
       NULL, 18, 675, now(), now()
...
ส่ง3-10-68', 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
...
ตกหล่น กำหนดส่ง 21.04.2569', 'หนูนา', 'หนูนา', '2026-05-07T17:00:00+07:00',
...
HB81 ครีมหม่นขาว
ก1.50*ส1.60 = 2 ผืน
ก1.50*ส2.00 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-07T17:00:00+07:00',
       NULL, 50, 764, now(), now()
...
ขาว แยกกลาง 2.00 =1ชุด', 'หนูนา', 'หนูนา', '2026-05-08T17:00:00+07:00',
...
224/70 ต.แพรกษาใหม่ อ.เมือง จ. สมุทรปราการ 10280', 'เบอร์ 0871546799', NULL, NULL, NULL, NULL,
       NULL, 'ส่งแล้ว', 'ชีทเคลม #0012 · สถานะในชีท: งานเสร็จแล้ว · ผิดโดย: บอย · ส่งแก้: หน้าร้าน · วิธีแก้: ส่งตะขอไป 1 ตัว', 'ตะขอเกี่ยวม่าน อะลูมิเนียม สีดำ', 'หนูนา', 'หนูนา', '2026-05-09T17:00:00+07:00',
       NULL, 18, 2, now(), now()
...
SHB94 Brick Brown
ก2.00*ส2.54 = 2 ผืน
ก2.20*ส2.79 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-09T17:00:00+07:00',
...
รางม่านตาไก่ สีสักลายไม้
ราง1ชั้น, 2.80 = 2 ชุด', 'หนูนา', 'หนูนา', '2026-05-03T17:00:00+07:00',
...
ส่งก่อน 2026-05-05 21:38', 'หนูนา', 'หนูนา', '2026-05-10T17:00:00+07:00',
...
ผ้าม่านลอนเทป 
S01 สีครีมมินิมอล
ก1.25* ส2.38 = 6 ผืน', 'หนูนา', 'หนูนา', '2026-05-11T17:00:00+07:00',
...
ราง2ชั้น (สีดำ) 
1.50 = 3 ชุด
1.53 = 1 ชุด', 'หนูนา', 'หนูนา', '2026-05-11T17:00:00+07:00',
       NULL, 18, 15, now(), now()
...
1.70*1.32 = 1 ชุด', 'หนูนา', 'หนูนา', '2026-05-11T17:00:00+07:00',
       NULL, NULL, 0, now(), now()
...
HB87 ลินินหม่นขาว 
· ก1.30*สูง1.50 =1ชุด ดึงซ้าย', 'หนูนา', 'หนูนา', '2026-05-11T17:00:00+07:00',
...
📍รางsnake2ชั้น สีไม้อ่อนแยกกลาง 1.60 = 1 ชุด (14+14)', 'หนูนา', 'หนูนา', '2026-05-13T17:00:00+07:00',
       NULL, 25, 98, now(), now()
...
4.00 = 1 ชุด
3.50=1 ชุด
3.20= 1 ชุด', 'หนูนา', 'หนูนา', '2026-05-13T17:00:00+07:00',
...
KB-1 Mocha gray 
ก2.50*ส2.10 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-13T17:00:00+07:00',
...
ขนาด 1.685 = 1 ชุด
ขนาด 2.485 = 1 ชุด 
ขนาด 2.785 = 1 ชุด', 'หนูนา', 'หนูนา', '2026-05-15T17:00:00+07:00',
       NULL, 25, 30, now(), now()
...
M21 sand  
ก0.605*ส1.60 = 1 ผืน 
ก0.75*ส1.60 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
...
หนาพิเศษ richy
1.00*1.20 =1ผืน', 'หนูนา', 'หนูนา', '2026-05-16T17:00:00+07:00',
...
ก1.30*ส1.25 = 1 ชุด 
ก1.25*ส1.25 = 2 ชุด', 'หนูนา', 'หนูนา', '2026-05-16T17:00:00+07:00',
       NULL, NULL, 0, now(), now()
...
ขาว1ชั้น เดี่ยว · 1.00 =1ชุด', 'หนูนา', 'หนูนา', '2026-05-16T17:00:00+07:00',
       NULL, 18, 25, now(), now()
...
ก2.2*ส2.7 = 1 ผืน
SHB98 Oatmeal 
ก3.60*ส2.9 = 1 ผืน', 'หนูนา', 'หนูนา', '2026-05-16T17:00:00+07:00',
...
ผ้าม่านซ่อนหู ใส่เคมี
S42 เทากรม
ก1.30*ส1.60 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-16T17:00:00+07:00',
...
ก2.75*ส2.655 = 1 ผืน(44)', 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
...
ม่านลอนเทป 
HB24
ก1.10*ส2.14 = 4 ผืน', 'หนูนา', 'หนูนา', '2026-05-28T17:00:00+07:00',
...
ก2.00*ส1.90 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-05-18T17:00:00+07:00',
       NULL, 25, 116, now(), now()
...
รวมทั้งหมด 17,538 บาท', 'หนูนา', 'หนูนา', '2026-05-18T17:00:00+07:00',
       NULL, 32, 444, now(), now()
...
SHB97 Linen Beige
ก1.80*ส1.50 = 2 ผืน
ก1.80*ส1.60 = 4 ผืน', 'หนูนา', 'หนูนา', '2026-05-19T17:00:00+07:00',
...
ผ้าโปร่ง Richy  
ก0.55*ส2.16 = 2 ผืน 
ก2.40*ส1.55 = 1', 'หนูนา', 'หนูนา', '2026-05-20T17:00:00+07:00',
...
Richy
7.28*2.035 = 1 ผืน', 'หนูนา', 'หนูนา', '2026-05-21T17:00:00+07:00',
       NULL, 18, 26, now(), now()
...
ก2.00*ส2.00 =2ผืน', 'หนูนา', 'หนูนา', '2026-05-21T17:00:00+07:00',
...
HB81 ครีมหม่นขาว · ก2.50*สูง2.30 =2ผืน', 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
...
(สั่งตัด) ผ้าม่านซ่อนหู ไม่ใส่เคมี โปร่งลายฝนขาวนวล
ก1.50*สูง2.00=4ผืน', 'หนูนา', 'หนูนา', '2026-05-24T17:00:00+07:00',
...
2.20 = 4 ชุด', 'หนูนา', 'หนูนา', '2026-05-24T17:00:00+07:00',
...
ม่านลอนเทป 
HB24
ก1.10*ส2.14 = 4 ผืน', 'หนูนา', 'หนูนา', '2026-05-26T17:00:00+07:00',
...
1.80=1ชิ้น', 'หนูนา', 'หนูนา', '2026-05-26T17:00:00+07:00',
       NULL, 63, 270, now(), now()
...
ยอดรวม=2081.90 บาทค่ะ', NULL, 'หนูนา', 'หนูนา', '2026-05-26T17:00:00+07:00',
...
(สั่งตัด) ผ้าม่านตาไก่ ขาว
SHB97 Linen Beige 
· ก1.80*สูง2.80 =2ผืน', 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
       65, 43, 3412, now(), now()
...
ตัวต่อรางลอนเทป =2 ชิ้น', NULL, 'หนูนา', 'หนูนา', '2026-06-01T17:00:00+07:00',
...
กรุงเทพฯ 10700
เบอร์โทรศัพท์ 0972982495', 'สู้', 'สู้', '2026-06-01T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
2ชั้น(กระดูม) สีขาว, 2.00  =1 ชุด', 'หนูนา', 'หนูนา', '2026-06-05T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
ใช้เทปของออร์เดอร์ 260519RS23QQ0N', 'หนูนา', 'หนูนา', '2026-06-06T17:00:00+07:00',
       NULL, 36, NULL, now(), now()
...
SHB91 Cotton ·
1.50*1.80 =2 ผืน', 'หนูนา', 'หนูนา', '2026-06-06T17:00:00+07:00',
       105, 63, NULL, now(), now()
...
KB-5 Sky gray
ก1.00* ส1.30 = 1 ผืน
ก1.80* ส1.30 = 1 ผืน', 'หนูนา', 'หนูนา', '2026-06-07T17:00:00+07:00',
       73, 38, NULL, now(), now()
...
ผ้าโปร่งลอนเทป 
ลายฝนขาวสว่าง
0.90*2.70 =2 ผืน', 'หนูนา', 'หนูนา', '2026-06-07T17:00:00+07:00',
       NULL, 36, NULL, now(), now()
...
📍ผ้าม่านลอนเทป
ผ้าโปร่งลายฝนขาวนวล
ก1.90*ส2.20 = 2 ผืน (16+16)', 'หนูนา', 'หนูนา', '2026-06-08T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
สั่งตัด) ผ้าม่านลอนเทป
HJJ-5 เทาเข้ม
0.90*1.80 = 2 ผืน (10+10)', 'หนูนา', 'หนูนา', '2026-06-08T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
HB26 Cinnamon 
ก2.80*ส2.70 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-06-08T17:00:00+07:00',
...
มัดจำ50% 14465.5 บาท ชำระก่อนจัดส่งอีก 14225.5 บาท', 'หนูนา', 'หนูนา', '2026-06-09T17:00:00+07:00',
...
ผ้าโปร่งลอนเทป 
Mid modern
1.87*2.79 = 8 ผืน 11,953 บาท', 'หนูนา', 'หนูนา', '2026-06-10T17:00:00+07:00',
...
สีขาว แยกกลาง, 1.80 =1ชุด', 'หนูนา', 'หนูนา', '2026-06-10T17:00:00+07:00',
       NULL, 63, NULL, now(), now()
...
(ดึงม่านซ้าย1 ขวา1)', 'หนูนา', 'หนูนา', '2026-06-10T17:00:00+07:00',
       NULL, 18, NULL, now(), now()
...
ม่านสอด
โปร่งลายฝนขาวสว่าง,
1.00*2.50= 2ผืน', 'หนูนา', 'หนูนา', '2026-06-11T17:00:00+07:00',
       NULL, 63, NULL, now(), now()
...
1ชั้น(กระดูม) สีสัก · 3.50  =1ชุด', 'หนูนา', 'หนูนา', '2026-06-11T17:00:00+07:00',
...
4/17 ซอยสุขใจ ถนนสุขุมวิท 40 แขวงพระโขนง เขตคลองเตย กรุงเทพฯ 10110', '081 3741477', NULL, NULL, NULL, NULL,
       NULL, 'ส่งแล้ว', 'ชีทเคลม #0067 · สถานะในชีท: งานเสร็จแล้ว · วิธีแก้: ตัวสไลด์รางจีบ แบบตรง =5 ชิ้น ปกติถ้าสั่งสไลด์เดี่ยวเราจะส่งตัวสไลด์ตัวงอไปให้ แต่ลูกค้าแจ้งว่า มันทำให้เกิดช่องแสงขึ้น เลยขอเป็นตัวสไลด์ตรง แะหลังจากนี้ จะใช้สไลด์ตรงเท่านั้น สำหรับสไลด์เดี่ยว', 'ตัวสไลด์รางจีบ', 'หนูนา', 'หนูนา', '2026-06-11T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
HB85 เทาเข้ม 
2.50*2.50 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-06-13T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
ดำ2ชั้น แยกกลาง · 2.50  = 1 ชุด', 'หนูนา', 'หนูนา', '2026-06-13T17:00:00+07:00',
...
จ.นครราชสีมา', '0896303742', NULL, NULL, NULL, NULL,
       NULL, 'ส่งแล้ว', 'ชีทเคลม #0070 · สถานะในชีท: งานเสร็จแล้ว · ส่งแก้: หน้าร้าน · วิธีแก้: ทำการส่ง สายรวบม่าน14 ชิ้น งานบ้านพี่ฟอง ร้านเราทำให้', NULL, 'หนูนา', 'หนูนา', '2026-06-13T17:00:00+07:00',
       NULL, 25, NULL, now(), now()
...
ผ้าม่านตาไก่ ตาไก่สุ่มสีขาว
D038 ขาวครีม
ก1.30*ส1.30 = 4 ผืน', 'หนูนา', 'หนูนา', '2026-06-13T17:00:00+07:00',
       48, 31, 910, now(), now()
...
โปร่งลายฝนขาวนวล
 ก2.00*สูง2.20 =1ผืน', 'หนูนา', 'หนูนา', '2026-06-15T17:00:00+07:00',
       NULL, 31, NULL, now(), now()
...
(สั่งตัด) ผ้าม่านตาไก่ สีขาว
M80 เทาเข้ม, 
3.50*สูง2.15 =2ผืน', 'หนูนา', 'หนูนา', '2026-06-15T17:00:00+07:00',
...
ขนาด 2.40 = 1 ชุด', 'หนูนา', 'หนูนา', '2026-06-16T17:00:00+07:00',
       NULL, 31, NULL, now(), now()
...
(สั่งตัด) ผ้าม่านลอนตะขอ ตะขอสั้น
ผ้าโปร่ง Richy
ก2.335*ส2.335 = 2 ผืน', 'หนูนา', 'หนูนา', '2026-06-17T17:00:00+07:00',
       173, 38, NULL, now(), now()
...
0.80 = 1 ชุด', 'หนูนา', 'หนูนา', '2026-06-21T17:00:00+07:00',
       NULL, 36, NULL, now(), now()
...
M20 เบจ, ก1.50*ส2.30 = 1 ผืน', 'หนูนา', 'หนูนา', '2026-06-22T17:00:00+07:00',
       NULL, NULL, NULL, now(), now()
...
ผ้าม่านตาไก่ สีสัก
HB26 ชินนาม่อน · 
ก1.50*ส1.80 =2ผืน', 'หนูนา', 'หนูนา', '2026-06-24T17:00:00+07:00',
...
SHB98 Oatmeal 
· กว้าง1.50*สูง2.25 =2ผืน', 'หนูนา', 'หนูนา', '2026-06-27T17:00:00+07:00',
       NULL, 76, NULL, now(), now()
...
(สั่งตัด) ม่านพับมินิมอล ระยะที่ใส่ห่วง ข้างละ 15 ซม
HB87
1.47*0.91 = 4 ชุดซ้าย2/ขวา2', 'หนูนา', 'หนูนา', '2026-07-02T17:00:00+07:00',
